...
mod test {
    ...
    vec![
      (
        ServerMessage::Announce {
          ...
          clients: HashMap::from([(uuid!["27293ea0-23c5-49e3-97ba-9d9337c1f414"].into(), "hardcoded".into())]),
        },
        vec![
          0, 1, 16, 115, 32, 55, 175, 211, 132, 77, 147, 171, 78, 235, 175, 100, 222, 135, 27, 1, 16, 39, 41, 62, 160,
          35, 197, 73, 227, 151, 186, 157, 147, 55, 193, 244, 20, 9, 104, 97, 114, 100, 99, 111, 100, 101, 100,
        ],
      ),
      (
        ServerMessage::Message(FullyQualifiedMessage {
        ...
        vec![
          1, 16, 80, 6, 77, 218, 134, 93, 64, 112, 168, 67, 170, 202, 41, 44, 184, 94, 16, 149, 191, 12, 236, 188, 242,
          74, 129, 182, 26, 83, 221, 179, 111, 20, 93, 2, 16, 167, 127, 119, 47, 112, 10, 64, 116, 155, 132, 226, 100,
          5, 13, 171, 89, 16, 47, 6, 253, 122, 142, 123, 70, 134, 159, 125, 102, 168, 228, 232, 145, 82, 16, 91, 130,
          107, 77, 243, 48, 75, 95, 131, 174, 198, 254, 5, 183, 247, 96, 16, 109, 26, 131, 191, 201, 1, 65, 108, 138,
  ...
  fn auth_hardcoded() -> Vec<(AuthMessage, Vec<u8>)> {
    vec![
      (
        AuthMessage::Auth {
          response: [199, 15, 141, 177, 121, 9, 136, 28, 127, 31, 230, 116, 79, 121, 111, 122],
        },
        vec![
      ...
      (
        ...
        vec![
          0, 16, 69, 9, 91, 78, 84, 157, 79, 217, 180, 208, 154, 164, 17, 28, 99, 36, 160, 172, 206, 207, 7, 198, 123,
          142,
        ],
      ),
      (
        ...
        vec![
          1, 16, 42, 30, 113, 91, 90, 94, 64, 107, 144, 70, 123, 225, 50, 168, 223, 39, 185, 213, 83, 150, 85, 248,
          241, 110,
        ],
      ),
    ]
  ...
  fn client_hardcoded() -> Vec<(ClientMessage, Vec<u8>)> {
    vec![
      (
        ...
        vec![
          0, 16, 115, 32, 55, 175, 211, 132, 77, 147, 171, 78, 235, 175, 100, 222, 135, 27, 8, 80, 50, 115, 54, 69, 82,
          112, 50,
        ],
      ),
      (
        ...
        vec![
          1, 4, 16, 199, 112, 82, 11, 203, 32, 79, 72, 138, 82, 145, 212, 198, 252, 8, 34, 16, 39, 41, 62, 160, 35,
          197, 73, 227, 151, 186, 157, 147, 55, 193, 244, 20, 16, 19, 202, 156, 201, 130, 223, 70, 228, 138, 16, 30,
          50, 55, 146, 128, 240, 16, 48, 190, 73, 154, 77, 78, 69, 106, 147, 16, 64, 70, 121, 194, 3, 194, 15, 103, 49,
          116, 76, 49, 82, 53, 56, 120, 53, 67, 48, 53, 106, 99,
        ],
      ),
    ]
  }
  ...
  fn u128() {
    ...
    let samples: [(u128, &[u8]); 10] = [
      ...
      (0x123456789abcdef0, &[253, 240, 222, 188, 154, 120, 86, 52, 18]),
      (0xffffffffffffffff, &[253, 255, 255, 255, 255, 255, 255, 255, 255]),
    ];
  ...
  fn client_query_register() {
    ...
    round_trip(encode::client_query, decode::client_query, &query, &[0, 3, 66, 111, 98]);
  }
  ...
  #[test]
  fn string_decode() {
    let mut cursor = Cursor::new([14, 72, 101, 108, 108, 111, 32, 87, 111, 114, 108, 100, 32, 59, 41]);
  ...
  fn sequence() {
    ...
    let encoded = &[
      12, 16, 119, 255, 82, 158, 117, 189, 72, 50, 191, 12, 109, 179, 57, 2, 41, 36, 253, 175, 206, 23, 164, 37, 0, 0,
